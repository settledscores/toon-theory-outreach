...
salutations = ["Hi", "Hey", "Hello", "Hi there", "Hey there", "Hello there"]
signatures = [
...
rotators = {
    ...
    "p2": VariantRotator(paragraph2),
    "p3": VariantRotator(paragraph3),
    "p4": VariantRotator(paragraph4),
    "p5": VariantRotator(paragraph5),
    "p6": VariantRotator(paragraph6),
    "p7": VariantRotator(paragraph7),
...
def parse_use_cases(raw):
    return [f"• {item.strip()}" for item in str(raw or "").split("|") if item.strip()]
